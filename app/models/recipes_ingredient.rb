class RecipesIngredient
  ...
  attr_accessor :i_name, :quantity, :measurement_id, :name, :portion, :time_count_id, :how_to, :tips, :calories, :is_public
  ...
  def save
    recipe = Recipe.create(name: name, portion: portion, time_count_id: time_count_id, how_to: how_to, tips: tips, calories: calories, is_public: is_public)
